...
from pyfieldsim.errors.exceptions import WrongCoordsFormatError
from pyfieldsim.errors.exceptions import WrongCoordsLengthError
    ...
    def lm_relation(self, e=3, cst=1):
        ...
        if self.mass is None:
            raise AttributeError(
                "Star must be generated, before luminosity "
                "can be defined."
            )
